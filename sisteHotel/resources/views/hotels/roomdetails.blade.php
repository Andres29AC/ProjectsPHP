      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-7 ftco-animate">
          	...
          	<h1 class="mb-4">{{$roomDetail->name}}</h1>
    ...
    <section class="ftco-section ftco-book ftco-no-pt ftco-no-pb">
    	<div class="container">
	    	<div class="row justify-content-end">
	    		<div class="col-lg-4">
					<form action="{{route('hotel.rooms.booking',$roomDetail->id)}}" method="POST" class="appointment-form" style="margin-top: -568px;">
						@csrf
			...
			<div class="container">
				<div class="row no-gutters">
					<div class="col-md-6 wrap-about">
						<div class="img img-2 mb-4" style="background-image: url('{{asset('images/room-2.jpg')}}');">
						</div>
