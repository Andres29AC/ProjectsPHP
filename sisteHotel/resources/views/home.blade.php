...
<div class="hero-wrap js-fullheight" style="margin-top: -25px;background-image: url('{{ asset('images/image_2.jpg')}}');">
            ...
            @foreach($hotels as $hotel)
                <div class="col-md-4 d-flex services align-self-stretch px-4 ftco-animate">
                    <div class="d-block services-wrap text-center">
                        <div class="img" style="background-image: url('{{ asset('images/'.$hotel->image.'')}}');"></div>
            ...
            @foreach($rooms as $room)
                <div class="col-lg-6">
                    <div class="room-wrap d-md-flex">
                        <a href="{{route('hotel.rooms.details',$room->id)}}" class="img" style="background-image: url('{{ asset('images/'.$room->image.'')}}');"></a>
