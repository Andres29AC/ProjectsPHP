...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">
        Clientes
        <lord-icon class="customers" src="https://cdn.lordicon.com/spukaklw.json" trigger="loop-on-hover" style="width:70px;height:70px">
        </lord-icon>
    </h1>
    <!-- dando un espacio -->
    <br>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                   {{$item->persona->estado == 1 ? '¿Esta seguro que desea eliminar el cliente?' : '¿Esta seguro que quieres restaurar el cliente?'}}
                                </div>
